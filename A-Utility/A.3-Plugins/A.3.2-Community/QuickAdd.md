...
↔️ (relacionado:: [[Templates]], [[Templater]])

---

<(previas::) | (siguientes::)>

**Descripción** (description:: Permite añadir contenido de varios tipos, entre ellos macros.)

**Comentario:** (comment:: Es excelente, tiene diversas opciones, y es muy bueno para complementar con [[Daily Notes]], [[Periodic Notes]] y con [[Templater]].)

**Enlace:** (enlace:: [QuickAdd (Repositorio de GitHub)](https://github.com/chhoumann/quickadd))
