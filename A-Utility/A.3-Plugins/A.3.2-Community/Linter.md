...
**Descripción:** (description:: Permite dar formato automáticamente a las notas, permitiendo una gran configuración)

**Comentario:** (comentario:: Resuelve perfectamente lo que ofrece, evitando que te preocupes por el formato, aunque la cantidad de opciones puede resultar algo abrumadora.)

**Enlace:** (enlace:: [Linter (Ayuda de Obsidian)](https://github.com/platers/obsidian-linter))
...
- Folders to ignore
	- "A-Utility/A.2-Templates"
	- "A-Utility/A.1-Classes"
...
- Dedupe YAML Array Values: `TRUE`
	- Dedupe YAML aliases section: `TRUE` *(Default)*
	- Dedupe YAML tags section: `TRUE` *(Default)*
	- Dedupe YAML array sections: `TRUE` *(Default)*
...
- Sort YAML Array Values: `TRUE`
	- Sort YAML aliases section: `TRUE` *(Default)*
	- Sort YAML tags section: `TRUE` *(Default)*
	- Sort YAML array sections: `TRUE` *(Default)*
	- YAML Keys to Ignore: ""
...
- YAML Timestamp: `TRUE`
	...
	- Update YAML Timestamp on File Contents Update: `Never` *(Default)*
...
- Strong Style: `TRUE`
	- Style: `asterisk`
- Line Break Between Lines With Content: `FALSE`
